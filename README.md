...
https://github.com/maskati/azure-icons/tree/main

## Download

An exported workflow should be available
under [releases](https://github.com/jarlefosen/alfred-gcloud-shortcuts/releases) make sure you meet
...
Specify the `authuser` query parameter in case you are logged into multiple Google accounts and you want to open links
logged into a specific user.
...
- save [auth locally](https://github.com/jarlefosen/alfred-gcloud-shortcuts/issues/5#issuecomment-537852834):
  `gcloud auth application-default login`

## Attribution

[alfred-gcloud-shortcuts](https://github.com/jarlefosen/alfred-gcloud-shortcuts) has been used to bootstrap this Alfred
workflow. 
